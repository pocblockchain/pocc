...
func TestStringifyFundraiserPathParams(t *testing.T) {
	...
	require.Equal(t, "44'/11111'/4'/0/22", path.String())

	path = NewFundraiserParams(4, types.CoinType, 57)
	require.Equal(t, "44'/11111'/4'/0/57", path.String())
...
func TestPathToArray(t *testing.T) {
	path := NewParams(44, 11111, 1, false, 4)
	require.Equal(t, "[44 11111 1 0 4]", fmt.Sprintf("%v", path.DerivationPath()))

	path = NewParams(44, 11111, 2, true, 15)
	require.Equal(t, "[44 11111 2 1 15]", fmt.Sprintf("%v", path.DerivationPath()))
}
...
func TestParamsFromPath(t *testing.T) {
	goodCases := []struct {
		...
		{&BIP44Params{44, 11111, 52, true, 41}, "44'/11111'/52'/1/41"},
	}
...
func ExampleSomeBIP32TestVecs() {
	...
	// daf9138af39e469c35ee76f55a6bd8353702e8eaf77a57a0d08c27682fe54910
