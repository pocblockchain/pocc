...
func TestPublicKeyUnsafe(t *testing.T) {
	...
	require.Equal(t, "eb5ae9872102ab92a7e886fbc9156ca1e70bd355c787357eb35d2062c16622b09b73c692b5ac",
	...
	require.Equal(t, "pocpub1addwnpepq24e9flgsmauj9tv58nsh564c7rn2l4nt5sx9stxy2cfku7xj266c7j3mcy",
		pubKeyAddr, "Is your device using test mnemonic: %s ?", tests.TestMnemonic)

	addr := sdk.AccAddress(priv.PubKey().Address()).String()
	require.Equal(t, "poc1ph37dparr8pzfe7qww4ngk9amzr38frh3xjq69",
