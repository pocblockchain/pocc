...
//
func TestAmountOf2(t *testing.T) {
	coins := NewCoins(NewInt64Coin("coin10", 100), NewInt64Coin("coin9", 90), NewInt64Coin("coin8", 80), NewInt64Coin("coin7", 70), NewInt64Coin("coin6", 60), NewInt64Coin("coin5", 50), NewInt64Coin("coin4", 40), NewInt64Coin("coin3", 30), NewInt64Coin("coin2", 20), NewInt64Coin("coin1", 10))
	assert.Equal(t, NewInt(90), coins.AmountOf("coin9"))
	assert.Equal(t, NewInt(80), coins.AmountOf("coin8"))
	assert.Equal(t, NewInt(70), coins.AmountOf("coin7"))
	assert.Equal(t, NewInt(60), coins.AmountOf("coin6"))
	assert.Equal(t, NewInt(50), coins.AmountOf("coin5"))
	assert.Equal(t, NewInt(40), coins.AmountOf("coin4"))
	assert.Equal(t, NewInt(30), coins.AmountOf("coin3"))
	assert.Equal(t, NewInt(20), coins.AmountOf("coin2"))
	assert.Equal(t, NewInt(10), coins.AmountOf("coin1"))
	assert.Equal(t, NewInt(100), coins.AmountOf("coin10"))
}
