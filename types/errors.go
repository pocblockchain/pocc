...
const (
	...
	CodeJSONUnmarshal     CodeType = 19
	//high level error codes

	CodeInvalidAccount          CodeType = 1000
	CodeSymbolAlreadyExist      CodeType = 1001
	CodeInvalidSymbol           CodeType = 1002
	CodeUnsupportToken          CodeType = 1003
	CodeInvalidTx               CodeType = 1004
	CodeTransactionIsNotEnabled CodeType = 1005
	CodeInvalidAmount           CodeType = 1006
	CodeEmptyDBGet              CodeType = 1040
	// CodespaceRoot is a codespace for error codes in this file only.
	// Notice that 0 is an "unset" codespace, which can be overridden with
	// Error.WithDefaultCodespace().
	CodespaceUndefined CodespaceType = ""
	CodespaceRoot      CodespaceType = "pocchain_base"
)
...
func ErrJSONUnmarshal(msg string) Error {
	return newErrorWithRootCodespace(CodeJSONUnmarshal, msg)
}

func ErrInvalidAmount(msg string) Error {
	return newErrorWithRootCodespace(CodeInvalidAmount, msg)
}
