...
import (
	...
	store "github.com/pocblockchain/pocc/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "poc/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "poc/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "poc/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "poc/baseapp/msgNoRoute", nil)
}
...
func TestSetMinGasPrices(t *testing.T) {
	minGasPrices := sdk.DecCoins{sdk.NewInt64DecCoin(sdk.NativeToken, 5000)}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "poc/baseapp/msgNoDecode", nil)
