...
import (
	...
	authsim "github.com/pocblockchain/pocc/x/auth/simulation"
	"github.com/pocblockchain/pocc/x/bank"
	distr "github.com/pocblockchain/pocc/x/distribution"
	distrsim "github.com/pocblockchain/pocc/x/distribution/simulation"
	"github.com/pocblockchain/pocc/x/gov"
	govsim "github.com/pocblockchain/pocc/x/gov/simulation"
	"github.com/pocblockchain/pocc/x/mint"
	"github.com/pocblockchain/pocc/x/params"
	paramsim "github.com/pocblockchain/pocc/x/params/simulation"
	"github.com/pocblockchain/pocc/x/simulation"
	"github.com/pocblockchain/pocc/x/slashing"
	slashingsim "github.com/pocblockchain/pocc/x/slashing/simulation"
	"github.com/pocblockchain/pocc/x/staking"
	stakingsim "github.com/pocblockchain/pocc/x/staking/simulation"
...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *PocApp) (
...
func testAndRunTxs(app *PocApp) []simulation.WeightedOperation {
	cdc := MakeCodec()
...
func invariants(app *PocApp) []sdk.Invariant {
	// TODO: fix PeriodicInvariants, it doesn't seem to call individual invariants for a period of 1
	// Ref: https://github.com/pocblockchain/pocc/issues/4631
	if period == 1 {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/pocblockchain/pocc/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewPocApp(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewPocApp(logger, db, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "PocApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewPocApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "PocApp", newApp.Name())
