...
var (
	valTokens  = sdk.TokensFromConsensusPower(4200)
...
func getMockApp(t *testing.T, numGenAccs int, genState GenesisState, genAccs []auth.Account) testInput {
	...
	bk := bank.NewBaseKeeper(mApp.AccountKeeper, nil, mApp.ParamsKeeper.Subspace(bank.DefaultParamspace), bank.DefaultCodespace, blacklistedAddrs)
