...
func TestTickPassedVotingPeriod(t *testing.T) {
	...
	t.Logf("minDeposit:%v", input.keeper.GetDepositParams(ctx).MinDeposit.String())
	proposalCoins := sdk.Coins{sdk.NewCoin(sdk.DefaultBondDenom, sdk.TokensFromConsensusPower(500))}
...
func TestProposalPassedEndblocker(t *testing.T) {
	...
	proposalCoins := sdk.Coins{sdk.NewCoin(sdk.DefaultBondDenom, sdk.TokensFromConsensusPower(1000))}
...
func TestEndBlockerProposalHandlerFailed(t *testing.T) {
	...
	proposalCoins := sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.TokensFromConsensusPower(1000)))
	newDepositMsg := NewMsgDeposit(input.addrs[0], proposal.ProposalID, proposalCoins)
	res := handler(ctx, newDepositMsg)
	require.True(t, res.IsOK())
