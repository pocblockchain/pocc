...
const (
	...
	InitInflationAmount      = "init_inflation_amount"
	InflactionFactors        = "inflation_factors"
...
var (
	...
	ModuleParamSimulator = map[string]func(r *rand.Rand) interface{}{
		...
		InitInflationAmount: func(r *rand.Rand) interface{} {
			return sdk.NewDecFromInt(sdk.NewIntWithDecimal(8100, 23))
		},
		InflactionFactors: func(r *rand.Rand) interface{} {
			return sdk.NewDec(1).Quo(sdk.NewDec(int64(r.Intn(5) + 1)))
		},
