...
func ErrStillInFrozen(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeUnauthorized,
		"cannot undelegate validator's operate before 1 year's frozen period")
}
