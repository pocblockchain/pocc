...
func TestMsgCreateValidator(t *testing.T) {
	...
	commission3 := NewCommissionRates(sdk.NewDecWithPrec(5, 2), sdk.NewDecWithPrec(5, 2), sdk.ZeroDec())
	...
	tests := []struct {
		...
		{"rate equal maxrate good", "a", "b", "c", "d", commission3, sdk.OneInt(), valAddr1, pk1, coinPos, true},
	}
