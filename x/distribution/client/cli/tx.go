...
import (
	...
	"github.com/pocblockchain/pocc/x/distribution/client/common"
...
Example:
$ %s tx distr withdraw-rewards pocvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey
$ %s tx distr withdraw-rewards pocvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey --commission
`,
...
Example:
$ %s tx set-withdraw-addr poc1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p --from mykey
`,
				version.ClientName,
			),
		),
