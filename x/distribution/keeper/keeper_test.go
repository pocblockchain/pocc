...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec(sdk.NativeToken, sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	distrAcc.SetCoins(sdk.NewCoins(
		...
		sdk.NewCoin(sdk.NativeToken, sdk.NewInt(2)),
	))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin(sdk.NativeToken, expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin(sdk.NativeToken, expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec(sdk.NativeToken, sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
