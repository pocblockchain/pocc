...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/pocblockchain/pocc/tree/master/CONTRIBUTING.md)
...
[master](https://github.com/pocblockchain/pocc/tree/master/docs).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/pocblockchain/pocc/blob/master/client/lcd/swagger-ui/swagger.yaml)
